  ...
  return (
    <ReactMarkdown
      components={{
        h1: (props) => (
          <h1
            className="mb-4 mt-6 text-3xl font-bold text-gray-800"
            {...props}
          />
        ),
        h2: (props) => (
        ...
        h3: (props) => (
          <h3
            className="mb-3 mt-4 text-xl font-bold text-gray-800"
            {...props}
          />
        ),
        h4: (props) => (
          <h4
            className="mb-2 mt-4 text-lg font-bold text-gray-800"
            {...props}
          />
        ),
        p: (props) => (
        ...
        blockquote: (props) => (
          <blockquote
            className="mb-4 border-l-4 border-primary/30 bg-primary/5 p-4 italic text-gray-700"
            {...props}
          />
        ),
        code: ({ children, ...props }) => {
          ...
          return (
            <code
              className="rounded-md bg-gray-100 px-1.5 py-0.5 text-sm text-gray-800"
              {...props}
            >
              {children}
            </code>
