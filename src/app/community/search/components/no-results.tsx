  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-xl bg-white dark:bg-gray-800 p-12 text-center shadow-soft">
      ...
      <p className="mb-6 max-w-md text-gray-600 dark:text-gray-300">
        ...
        <span className="font-medium">{query}</span>&quot;. Try using different
        keywords or check out some popular topics.
      </p>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <Button
          ...
          asChild
        >
          <Link href="/community/design">Design</Link>
        </Button>
        <Button
          variant="outline"
          className="border-primary text-primary dark:border-primary-light dark:text-primary-light hover:bg-primary/5 dark:hover:bg-primary-light/10"
          asChild
        >
          <Link href="/community/development">Development</Link>
        </Button>
        <Button
          variant="outline"
          className="border-primary text-primary dark:border-primary-light dark:text-primary-light hover:bg-primary/5 dark:hover:bg-primary-light/10"
          asChild
        >
          <Link href="/community/general">General</Link>
        </Button>
      </div>
    </div>
  );
